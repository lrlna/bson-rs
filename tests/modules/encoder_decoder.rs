...
fn test_encode_decode_utf8_string() {
    ...
    let dst = vec![
        28, 0, 0, 0, 2, 107, 101, 121, 0, 14, 0, 0, 0, 116, 101, 115, 116, 228, 189, 160, 229, 165, 189, 229, 144, 151,
        0, 0,
    ];
...
fn test_encode_decode_array() {
    ...
    let dst = vec![
        37, 0, 0, 0, 4, 107, 101, 121, 0, 27, 0, 0, 0, 1, 48, 0, 41, 92, 143, 194, 245, 40, 240, 63, 2, 49, 0, 4, 0, 0,
        0, 120, 121, 122, 0, 0, 0,
    ];
...
fn test_encode_decode_document() {
    ...
    let dst = vec![
        27, 0, 0, 0, 3, 107, 101, 121, 0, 17, 0, 0, 0, 16, 115, 117, 98, 107, 101, 121, 0, 1, 0, 0, 0, 0, 0,
    ];
...
fn test_encode_decode_decimal128() {
    ...
    let val = Bson::Decimal128(Decimal128::from_raw_bytes_le(vec));
    let dst = vec![
